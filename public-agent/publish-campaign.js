...
(function (root) {
  ...
  const WAIT = {
    ...
    profile_busy: "פייסבוק פתוח כרגע בדפדפן אחר של פורלי (חיבור, ייבוא או גלילה) — הפוסט יתוזמן כשיסתיים.",
    login_open: "חלון ההתחברות לפייסבוק פתוח — הפוסט יתוזמן אחרי שתסיימו.",
  };
