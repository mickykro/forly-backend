...
- [x] Inventory all server-delivered pages, routes, and the demo-creation flow.
- [x] Define shared FORLY visual tokens and reusable layout patterns for the redesign.
