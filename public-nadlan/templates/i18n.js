...
(function () {
  ...
  var DICT = {
    "he": {
      ...
      "why_here": "למה דווקא כאן", "the_property": "הנכס", "peek_inside": "הצצה פנימה", "your_home": "הבית שלך", "whats_inside": "מה יש בפנים", "gallery": "גלריה", "moments_from_tour": "רגעים מתוך הסיור",
    ...
    "en": {
      ...
      "why_here": "Why here", "the_property": "The property", "peek_inside": "A peek inside", "your_home": "Your home", "whats_inside": "What's inside", "gallery": "Gallery", "moments_from_tour": "Moments from the tour",
    ...
    "ar": {
      ...
      "why_here": "لماذا هنا تحديدًا", "the_property": "العقار", "peek_inside": "إطلالة من الداخل", "your_home": "بيتك", "whats_inside": "ما الذي بالداخل", "gallery": "المعرض", "moments_from_tour": "لحظات من الجولة",
    ...
    "ru": {
      ...
      "why_here": "Почему именно здесь", "the_property": "Объект", "peek_inside": "Взгляд внутрь", "your_home": "Ваш дом", "whats_inside": "Что внутри", "gallery": "Галерея", "moments_from_tour": "Моменты из тура",
    ...
    "es": {
      ...
      "why_here": "Por qué aquí", "the_property": "El inmueble", "peek_inside": "Un vistazo dentro", "your_home": "Tu casa", "whats_inside": "Lo que hay dentro", "gallery": "Galería", "moments_from_tour": "Momentos del recorrido",
    ...
    "fr": {
      ...
      "why_here": "Pourquoi ici", "the_property": "Le bien", "peek_inside": "Un aperçu de l'intérieur", "your_home": "Votre maison", "whats_inside": "Ce qu'il y a à l'intérieur", "gallery": "Galerie", "moments_from_tour": "Instants de la visite",
